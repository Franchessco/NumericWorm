...
namespace NumericStorm {
	namespace Fitting
	{
		...
		public:
			...
			template<typename T_o>
			Parameters<s_p, T_p>& operator += (const Parameters<s_p, T_o>& other) //const //!< already pointed out by someone else
			{
			...
			Parameters<s_p, T_p> operator + (const auto& other) const { auto result = *this; result += other; return result; };
			Parameters<s_p, T_p> operator - (const auto& other) const { auto result = *this; result -= other; return result; };
			Parameters<s_p, T_p> operator * (const auto& other) const { auto result = *this; result *= other; return result; };
			Parameters<s_p, T_p> operator / (const auto& other) const { auto result = *this; result /= other; return result; };
